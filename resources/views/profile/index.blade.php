...
@section('title', 'Профиль - CarRental')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-500">Споры</p>
                            <p class="text-2xl font-bold text-gray-900">{{ $myDisputes->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    @if ($car->is_promoted)
                                                        <span
                                                            class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-yellow-100 to-orange-100 text-yellow-800 mt-1">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="mt-6 bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('profile.edit') }}"
                                class="flex items-center p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl hover:from-green-100 hover:to-emerald-100 transition-all duration-300">
                                <i class="fas fa-user-edit text-green-500 mr-3"></i>
                                <span class="font-medium text-gray-700">Настройки</span>
                            </a>
                        </div>
                    </div>
                </div>
